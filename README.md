...
# 2. Verify the arguments were successfully appended to the bootloader
...
# 2. Install and enable the Remote Desktop Protocol (RDP) service
sudo dnf install xrdp -y
sudo systemctl enable --now xrdp

# 3. Open the RDP port in the Fedora firewall
